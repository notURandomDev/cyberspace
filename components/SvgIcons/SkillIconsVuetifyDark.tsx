...
export function SkillIconsVuetifyDark(props: SVGProps<SVGSVGElement>) {
  return (
    <svg
    ...
    >
      ...
      <g fill="none">
        ...
        <defs>
          <clipPath id="skillIconsVuetifyDark0">
            <path fill="#fff" d="M0 0h256v256H0z" />
          </clipPath>
          <clipPath id="skillIconsVuetifyDark1">
